...
export const metadata: Metadata = {
  title: 'Abdi Nusantara Bhakti | Budaya, Pengabdian, dan Inovasi Nusantara',
  ...
  authors: [{ name: 'Abdi Nusantara Bhakti' }],
  openGraph: {
    title: 'Abdi Nusantara Bhakti | Budaya, Pengabdian, dan Inovasi Nusantara',
    ...
    siteName: 'Abdi Nusantara Bhakti',
    locale: 'id_ID',
