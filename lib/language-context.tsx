...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "about.description": "AN Bhakti is a globally-funded foundation dedicated to preserving, developing, and promoting Indonesian cultural heritage. We believe that culture is not merely a legacy of the past, but a compass for our civilization's future.",
    ...
    "donate.secured": "Secured by 2C2P Payment Gateway",
    ...
    // Legal
    "legal.title": "Foundation Legality",
    "legal.description": "Bhakti Abdi Nusantara Jaya Foundation is a legal entity that has been ratified by the Ministry of Law and Human Rights of the Republic of Indonesia.",
    "legal.badge": "Registered & Legal Entity",
    "legal.status": "Status",
    "legal.statusValue": "Foundation Legal Entity",
    "legal.sk": "Ministry of Law Decree",
    "legal.skValue": "AHU-0016615.AH.01.04.Tahun 2026",
    "legal.akta": "Deed of Establishment",
    "legal.aktaValue": "Number 39 • July 23, 2026",
    "legal.npwp": "Tax ID Number",
    "legal.npwpValue": "10.474.087.0-007.000",
  },
  id: {
    // Navigation
    "nav.home": "Beranda",
    ...
    "about.description": "AN Bhakti adalah yayasan yang didanai secara global yang berdedikasi untuk melestarikan, mengembangkan, dan mempromosikan warisan budaya Indonesia. Kami percaya bahwa kebudayaan bukan sekadar warisan masa lalu, melainkan kompas untuk masa depan peradaban kita.",
    ...
    // Legal
    "legal.title": "Legalitas Yayasan",
    "legal.description": "Yayasan Bhakti Abdi Nusantara Jaya merupakan badan hukum yang telah disahkan oleh Kementerian Hukum Republik Indonesia.",
    "legal.badge": "Terdaftar & Berbadan Hukum",
    "legal.status": "Status",
    "legal.statusValue": "Badan Hukum Yayasan",
    "legal.sk": "SK Kementerian Hukum",
    "legal.skValue": "AHU-0016615.AH.01.04.Tahun 2026",
    "legal.akta": "Akta Pendirian",
    "legal.aktaValue": "Nomor 39 • 23 Juli 2026",
    "legal.npwp": "NPWP",
    "legal.npwpValue": "10.474.087.0-007.000",
  },
}
